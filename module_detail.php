    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            <ol class="am-breadcrumb">
                ...
                <li><a href="module_list.php?d=<?php echo $_GET['d'];?>">模块列表</a></li>
                 <li><a href="#"><?php echo $m->get_module_p_name();?></a></li>
            </ol>
            <div class="tpl-content-scope">
                    <div class="note note-info">
                    <table class="am-table am-table-compact" style="width:98%;border-collapse:collapse;" id="p-table-con" align="center" valign="middle">
                            <?php $m->get_module_detail();?>
                    </table>
                </div>
                <div class="am-btn-group" style="float:right;">
                                                 <a href="<?php $m->get_page_link($_GET['id'],"module","frist");?>" class="am-btn am-btn-primary am-round am-btn-xs <?php if($m->get_page_start_end($_GET['id'],"module","frist")==1){echo "am-disabled";}?>">< 上一个</a>
                                                <a  class="am-btn am-btn-primary am-round am-btn-xs" onclick="print();" >打印本页</a>
                                                <a  class="am-btn am-btn-primary am-round am-btn-xs" data-am-modal="{target: '#m-del'}" >删除本页</a>
                                                <a  href="<?php $m->get_page_link($_GET['id'],"module","last");?>" class="am-btn am-btn-primary am-round am-btn-xs <?php if($m->get_page_start_end($_GET['id'],"module","last")==1){echo "am-disabled";}?>" >下一个 ></a>
                  </div>
            </div>
                        ...
                        <div class="am-modal am-modal-alert" tabindex="-1" id="m-del">
                                      <div class="am-modal-dialog">
                                        <div class="am-modal-hd"></div>
                                        <div class="am-modal-bd">
                                        <span class="am-icon-exclamation-circle"></span>
                                          注意:删除模块将同时删除包含此模块的项目
                                        </div>
                                        <div class="am-modal-footer">
                                        <span class="am-modal-btn" data-am-modal-cancel>取消</span>
                                          <span class="am-modal-btn" id="module-del-sub" del="<?php echo $_GET['id'];?>" dpm="<?php echo $_GET['d'];?>">确认</span>
                                        </div>
                                      </div>
                                    </div>
